            ...
            <div className="options">
                <div className="confirm">
                    <svg width="71" height="53" viewBox="0 0 71 53" fill="none" xmlns="http://www.w3.org/2000/svg">
                        <line x1="1.06066" y1="29.9393" x2="22.2739" y2="51.1525" stroke="white" stroke-width="3"/>
                        <line x1="19.9393" y1="51.4368" x2="69.4368" y2="1.93933" stroke="white" stroke-width="3"/>
                    </svg>
                </div>
                ...
                <div className="close" onClick={() => changeFormDisplay(false)}>
                    <svg width="55" height="53" viewBox="0 0 55 53" fill="none" xmlns="http://www.w3.org/2000/svg">
                        <line x1="1.93934" y1="51.4368" x2="51.4368" y2="1.93933" stroke="white" stroke-width="3"/>
                        <line x1="4.06066" y1="1.93934" x2="53.5581" y2="51.4368" stroke="white" stroke-width="3"/>
                    </svg>
                </div>
            </div>
